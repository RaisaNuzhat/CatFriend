...
import { FontAwesome5 } from '@expo/vector-icons'; // Importing icons from FontAwesome5

// Sample data for posts
const postsData = [
  { id: 1, author: 'Raisa Nuzhat', content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', likes: 5, dislikes: 2 },
  { id: 2, author: 'Ratri Barua', content: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', likes: 10, dislikes: 3 },
        ...
        <ScrollView style={styles.content}>
          ...
          {posts.map(post => (
            <View key={post.id} style={styles.postContainer}>
              ...
              {/* Add image and video components here */}
